...
<body>
    <div class="add-question-container">
        <h1 class="question-title">Add New Question</h1>
        <form action="add-question" method="post">
            <div class="form-group">
                <label for="exam_id" class="question-label">Exam ID:</label>
                <input type="number" id="exam_id" name="exam_id" class="question-input" required>
            </div>
            <div class="form-group">
                <label for="question_text" class="question-label">Question:</label>
                <textarea id="question_text" name="question_text" class="question-input" required></textarea>
            </div>
            <div class="form-group">
                <label for="option_a" class="question-label">Option A:</label>
                <input type="text" id="option_a" name="option_a" class="question-input" required>
            </div>
            <div class="form-group">
                <label for="option_b" class="question-label">Option B:</label>
                <input type="text" id="option_b" name="option_b" class="question-input" required>
            </div>
            <div class="form-group">
                <label for="option_c" class="question-label">Option C:</label>
                <input type="text" id="option_c" name="option_c" class="question-input" required>
            </div>
            <div class="form-group">
                <label for="option_d" class="question-label">Option D:</label>
                <input type="text" id="option_d" name="option_d" class="question-input" required>
            </div>
            <div class="form-group">
                <label for="correct_option" class="question-label">Correct Option:</label>
                <select id="correct_option" name="correct_option" class="question-input" required>
            ...
            <button type="submit" class="question-submit-button">Add Question</button>
        </form>
        <a  href="manage-exam.jsp">
        <button class="question-back-button">Back</button>
        </a>
