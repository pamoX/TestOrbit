...
<body>
    ...
    <main style="marging-top:2%" class="mx-4">
       ...
       <div class="col-6 mx-auto">
           <form action="insertexams_schedule">
               <h2>Add Exams </h2>
               <div class="form-group mb-2 row">
                  <label class="col-sm-2 col-form-label">Exam_Name</label>
                  <input type="text" name="exam_Name" class="form-control boarder-primary" placeholder="Enter exam name.." required>
               </div>
               
                <div class="form-group mb-2 row">
                  <label class="col-sm-2 col-form-label">Date</label>
                  <input type="date" name="date" class="form-control boarder-primary" required>
               </div>
               
                <div class="form-group mb-2 row">
                  <label class="col-sm-2 col-form-label">Time</label>
                  <input type="time" name="time" class="form-control boarder-primary" required>
               </div>
               
                <div class="form-group mb-2 row">
                  <label class="col-sm-2 col-form-label">Description</label>
                  <input type="text" name="discription" class="form-control boarder-primary" placeholder="Enter exam details.." required>
               </div>
               
               <br>
                <div class="form-group mb-2 row">
                     <input type="submit" class="btn btn-success" value="Insert Details ">
