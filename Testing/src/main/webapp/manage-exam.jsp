...
.question-update-submit-btn:hover {
 ...
 /* General resets and container styling */
* {
	margin: 0;
	box-sizing: border-box;
}
...
.container {
	flex: 1; /* Content container will take up available space */
	max-width: 600px;
	margin: auto;
	text-align: center;
	background: white;
...
<div class="container">
	...
	<a href='addquestion.jsp' class="button">Add Question</a> 
	<a href='question-dashboard' class="button">Manage Question</a>
