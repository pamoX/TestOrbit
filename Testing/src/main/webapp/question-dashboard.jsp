...
<body>
    ...
    <div class="question-dashboard-container">
        <h1 class="question-dashboard-title">Question Dashboard</h1>
        <table class="question-dashboard-table">
            <thead>
                <tr>
                    <th class="question-dashboard-header">Question ID</th>
                    <th class="question-dashboard-header">Exam ID</th>
                    <th class="question-dashboard-header">Question Text</th>
                    <th class="question-dashboard-header">Option A</th>
                    <th class="question-dashboard-header">Option B</th>
                    <th class="question-dashboard-header">Option C</th>
                    <th class="question-dashboard-header">Option D</th>
                    <th class="question-dashboard-header">Correct Option</th>
                    <th class="question-dashboard-header">Actions</th>
                </tr>
            </thead>
            <tbody>
            	<c:forEach var="question" items="${questions}">
                <tr class="question-dashboard-row">
                    <td class="question-dashboard-cell">${ question.id }</td>
                    <td class="question-dashboard-cell">${ question.examId }</td>
                    <td class="question-dashboard-cell">${ question.questionText }</td>
                    <td class="question-dashboard-cell">${ question.optionA }</td>
                    <td class="question-dashboard-cell">${ question.optionB }</td>
                    <td class="question-dashboard-cell">${ question.optionC }</td>
                    <td class="question-dashboard-cell">${ question.optionD }</td>
                    <td class="question-dashboard-cell">${ question.correctOption }</td>
                    <td class="question-dashboard-cell">
                        <a href="update-question?id=${ question.id }"  class="question-dashboard-update-btn">Update</a>
                        <a href="delete-question?id=${ question.id }" class="question-dashboard-delete-btn">Delete</a>
                    </td>
                </tr>
				</c:forEach>
