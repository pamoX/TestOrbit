...
<head>
<meta charset="UTF-8">
<title>Grade Details Form</title>
...
<header>
    ...
    <div class ="row">
    	<div class ="container">
    	<h3 class="text-start mx-2">Welcome to Exam Results Page</h3>
    	
    	</div>
    	
    	<div class = "text-start">
    		<a href= "gradeInsert.jsp" class="btn btn-primary btn-sm mx-2">Add new grade</a>
    	...
    	<tbody>
    	<c:forEach var="Rslt" items="${Rslt}">
    	
    	<tr>
    		<td><c:out value="${Rslt.id}"></c:out></td>
    		<td><c:out value="${Rslt.studentId}"></c:out></td>
    		<td><c:out value="${Rslt.module}"></c:out></td>
    		<td><c:out value="${Rslt.exam}"></c:out></td>
    		<td><c:out value="${Rslt.marks}"></c:out></td>
    		<td><c:out value="${Rslt.grade}"></c:out></td>
    		<td><c:out value="${Rslt.comments}"></c:out></td>
    		
    		
    		<td>
    		<a href = "gUpdate?id=<c:out value='${Rslt.id}'/>" class="btn btn-success btn-sm">Update</a>
    		<a href = "deleteGrade?id=<c:out value='${Rslt.id}'/>" class="btn btn-danger btn-sm">Delete</a>
    		</td>
    		</tr>
